...
- ✅ Fixed full run boot flow regression by removing the duplicate `RunScene` startup path that launched Phaser without session/bridge data, which caused blank visuals and dead controls/audio at runtime.
